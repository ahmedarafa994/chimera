...
class LLMProviderClient:
    ...
    def _handle_error(self, response: requests.Response) -> str:
        ...
        try:
            ...
            logger.debug("Error parsing API response JSON: %s", exc)
        ...
        try:
            ...
            if not parts:
                ...
                if finish_reason == "SAFETY":
                    ...
                    # Rare case: STOP but no parts. Could be an empty generation.
                    # Check if there's any other field or just return empty string.
                    logger.warning(f"Gemini STOP reason with no parts. Full candidate: {candidate}")
                ...
                if not content:
                    # Could be function call or other modality
    ...
    def from_env(provider: LLMProvider) -> LLMProviderClient:
        ...
        if provider == LLMProvider.OPENAI:
            ...
            config = ProviderConfig(
                ...
                cost_per_1k_tokens=0.00125,  # Gemini 1.5 Pro pricing
            )
