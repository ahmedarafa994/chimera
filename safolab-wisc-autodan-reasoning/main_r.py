...
if __name__ == "__main__":
    ...
    if args.hot_lifelong:
        with open("./logs_r/warm_up_strategy_library.pkl", "rb") as f:
        ...
        with open("./logs_r/warm_up_attack_log.json", encoding="utf-8") as f:
            warm_up_attack_log = json.load(f)
        with open("./logs_r/warm_up_summarizer_log.json", encoding="utf-8") as f:
            warm_up_summarizer_log = json.load(f)
        autodan_turbo_pipeline.hot_start_lifelong(warm_up_attack_log)
    else:
        if args.hot:
            with open(f"./logs_r/warm_up_attack_log{suffix}.json", encoding="utf-8") as f:
