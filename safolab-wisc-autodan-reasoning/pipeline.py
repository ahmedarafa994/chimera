...
class AutoDANTurbo:
    def __init__(
        ...
        self.non_compliance_list = [
            "I cannot",
            "I am unable",
            "I can't",
        ]  # A quick check of non-compliance message
                ...
                for j in range(self.epochs):
                    ...
                    while not_scussed:
                        try:
                            ...
                            # Try to wrap the assessment into a score; retry on wrapper failure
                            ...
                            # normalize scorer system variable name for logging
                            scorer_system = _scorer_system
                            ...
                            # Exit the outer retry loop after successful scoring
                            not_scussed = False
            ...
            for request_id in range(len(self.data["lifelong"])):
                ...
                for j in range(self.epochs):
                    ...
                    if j == 0:
                        ...
                        if valid:
                            jailbreak_prompt, _attacker_system = self.attacker.use_strategy(
                                request,
                                retrival_strategy_list,
                                max_length=10000,
                                do_sample=True,
    ...
    def test(self, request, input_strategy_library):
        ...
        for j in range(self.epochs):
            if j == 0:
                jailbreak_prompt, _attacker_system = self.attacker.warm_up_attack(
                    request, max_length=10000, do_sample=True, temperature=1.0, top_p=1
                )
                for word in self.non_compliance_list:
                    if word in jailbreak_prompt:
