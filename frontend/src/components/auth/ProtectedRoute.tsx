...
export function ProtectedRoute({
  ...
  useEffect(() => {
    if (isInitialized && isAuthStateReady && !isLoading && !isAuthenticated) {
  ...
  }, [isInitialized, isAuthStateReady, isLoading, isAuthenticated, pathname, redirectTo, router, onRedirect]);
