...
def run_evasion_task(self, task_id: str, evasion_config_dict: dict[str, Any]) -> None:
    ...
    try:
        ...
        for attempt_num in range(1, evasion_config.max_attempts + 1):
            ...
            try:
                ...
                logger.exception(
                    f"Celery Task {task_id}: Attempt {attempt_num} failed with error: {e}"
                )
