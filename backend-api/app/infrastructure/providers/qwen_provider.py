...
class QwenProvider(BaseProvider):
    ...
    # Qwen API endpoints (OpenAI-compatible via DashScope)
    ...
    async def _check_health_impl(self, client: httpx.AsyncClient) -> bool:
        ...
        try:
            ...
            logger.debug(f"[qwen] Health check failed: {e}")
            return False
            ...
            async with client.stream("POST", "chat/completions", json=payload) as response:
                ...
                async for line in response.aiter_lines():
                    ...
                    try:
                        ...
                        logger.warning(f"[qwen] Failed to parse streaming chunk: {data_str}")
                        continue
