...
class TargetLLM(LLM):
    ...
    def converse(self, request):
        ...
        try:
            ...
            requestCost = self.tokenCalculator.calculate_cost(requestTokens, isRequest=True)
            responseCost = self.tokenCalculator.calculate_cost(responseTokens, isRequest=False)
