...
async def get_global_stats(
    ...
    try:
        ...
        logger.exception(f"Failed to get global stats: {e}")
        raise HTTPException(
...
async def get_technique_combinations(
    ...
    try:
        ...
        logger.exception(f"Failed to get technique combinations: {e}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def create_technique(
    ...
    try:
        ...
        logger.exception(f"Failed to create technique: {e}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def list_techniques(
    ...
    limit: Annotated[int | None, Query(ge=1, le=100, description="Items per page (alias)")] = None,
    offset: Annotated[int | None, Query(ge=0, description="Offset for pagination (alias)")] = None,
    category: Annotated[str | None, Query(description="Filter by category")] = None,
    technique_type: Annotated[TechniqueType | None, Query(description="Filter by type")] = None,
    status: Annotated[TechniqueStatus | None, Query(description="Filter by status")] = None,
    visibility: Annotated[VisibilityLevel | None, Query(description="Filter by visibility")] = None,
    ...
    try:
        ...
        logger.exception(f"Failed to list techniques: {e}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    try:
        ...
        if not has_access:
            raise HTTPException(
                ...
                detail="Access denied to this technique",
            )
        ...
        logger.exception(f"Failed to get technique {technique_id}: {e}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to retrieve technique",
        )
...
async def update_technique(
    ...
    try:
        ...
        if technique.created_by != current_user.id:
            raise HTTPException(
                status_code=status.HTTP_403_FORBIDDEN,
                detail="Only technique creator can update",
            )
        ...
        logger.exception(f"Failed to update technique {technique_id}: {e}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to update technique",
        )
...
async def test_technique(
    ...
    try:
        ...
        logger.exception(f"Failed to test technique {technique_id}: {e}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to test technique",
        )
...
async def get_technique_stats(
    ...
    try:
        ...
        logger.exception(f"Failed to get technique stats {technique_id}: {e}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to retrieve technique statistics",
        )
...
async def clone_technique(
    ...
    try:
        ...
        logger.exception(f"Failed to clone technique {technique_id}: {e}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to clone technique",
        )
...
async def delete_technique(
    ...
    try:
        ...
        if technique.created_by != current_user.id:
            raise HTTPException(
                status_code=status.HTTP_403_FORBIDDEN,
                detail="Only technique creator can delete",
            )
        ...
        logger.exception(f"Failed to delete technique {technique_id}: {e}")
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to delete technique",
        )
