...
class LLMProviderPricingManager:
    ...
    def get_cost_efficient_alternatives(
        ...
        alternatives = []
        current_avg_cost = (
            current_pricing.input_token_cost_per_1k + current_pricing.output_token_cost_per_1k
        ) / 2
        ...
        for provider, models in self.provider_pricing.items():
            for model, pricing in models.items():
                ...
                # Check cost ratio
                alt_avg_cost = (
                    pricing.input_token_cost_per_1k + pricing.output_token_cost_per_1k
                ) / 2
...
class CostOptimizationEngine:
    ...
    def analyze_cost_trends(self, hours_back: int = 24) -> dict[str, Any]:
        ...
        recent_costs = [
            record for record in self.cost_history if record["timestamp"] >= cutoff_time
        ]
    ...
    def generate_cost_report(self) -> dict[str, Any]:
        ...
        return {
            ...
            "summary": {
                ...
                "budget_status": (
                    "healthy"
                    if cost_analysis.get("budget_utilization", {}).get("daily", 0) < 0.8
                    else "warning"
                ),
            },
        }
