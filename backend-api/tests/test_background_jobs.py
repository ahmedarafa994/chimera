...
class TestBackgroundJobService:
    ...
    @pytest.mark.asyncio
    async def test_submit_job(self, job_service):
    ...
    @pytest.mark.asyncio
    async def test_list_jobs(self, job_service):
        """Test listing jobs."""
    ...
    @pytest.mark.asyncio
    async def test_list_jobs_with_status_filter(self, job_service):
    ...
    @pytest.mark.asyncio
    async def test_update_progress(self, job_service):
    ...
    @pytest.mark.asyncio
    async def test_update_progress_clamps_values(self, job_service):
    ...
    @pytest.mark.asyncio
    async def test_get_stats(self, job_service):
    ...
    @pytest.mark.asyncio
    async def test_job_execution(self, started_job_service):
        """Test that jobs are actually executed."""
        result_holder = {"value": None}

        async def task_that_sets_value():
    ...
    @pytest.mark.asyncio
    async def test_job_failure_handling(self, started_job_service):
...
class TestBackgroundJobServiceSingleton:
    ...
    def test_get_background_job_service(self):
