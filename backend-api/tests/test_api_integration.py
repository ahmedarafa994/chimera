...
class TestCORSHeaders:
    ...
    def test_cors_headers_on_options(self, client) -> None:
...
class TestWebSocketEndpoints:
    ...
    def test_websocket_endpoint_exists(self, client) -> None:
