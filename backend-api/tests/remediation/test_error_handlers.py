...
class TestApiErrorHandler:
    ...
    async def test_handles_value_error(self) -> None:
        ...
        @api_error_handler("test_endpoint")
        async def bad_input_func() -> Never:
    ...
    @pytest.mark.asyncio
    async def test_passes_through_http_exception(self) -> None:
        """Test decorator passes through existing HTTPExceptions."""

        @api_error_handler("test_endpoint")
        async def http_error_func() -> Never:
    ...
    async def test_handles_unexpected_exception(self) -> None:
        ...
        @api_error_handler("test_endpoint")
        async def unexpected_error_func() -> Never:
    ...
    @pytest.mark.asyncio
    async def test_includes_request_id_in_response(self) -> None:
